 ...
 */
package org.quickstart.cache.redis.redisson.v3x.collections;
...
public class LocalCachedMapExamples {
    ...
    public static void main(String[] args) {
        ...
        LocalCachedMapOptions options =
                LocalCachedMapOptions.defaults().cacheSize(10000).evictionPolicy(EvictionPolicy.LRU).maxIdle(10, TimeUnit.SECONDS).timeToLive(60, TimeUnit.SECONDS).invalidateEntryOnChange(true);
