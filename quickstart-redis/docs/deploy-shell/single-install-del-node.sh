...
#How many slotsdoyou want to move (from1to16384)?1365
#通过人工手动查看数据分片总大小

#Whatisthe receiving node ID? e64f9074a3733fff7baa9a4848190e56831d5447
#选择接收数据分片的节点ID
...
#How many slotsdoyou want to move (from1to16384)?1366
#通过人工手动查看数据分片总大小

#Whatisthe receiving node ID? f6c1aaea3a8c56e0c7dee8ad7ae17e26dd04244c
