...
#删除清空数据片的主节点：
#'删除已经清空数据的7006实例
redis-5.0.8/src/redis-cli --cluster del-node 127.0.0.1:7006 39e2074134089c7ea6b589735c25078c6a7f0610
#删除没有主库的7007实例
redis-5.0.8/src/redis-cli --cluster del-node 127.0.0.1:7007 539b42570a46e620ceb1fc7cb830530890a784d5
...
#内存信息查看
redis-5.0.8/src/redis-cli -p 7000 -a redhat info memory

#设置最大只能使用100MB的内存
#redis-5.0.8/src/redis-cli -p 7000 -a redhat config set maxmemory 102400000
