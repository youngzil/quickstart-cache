 ...
 * 
 */
package org.quickstart.cache.memcached.alisoft.xplatform.asf.cache;
...
public class IMemcachedCacheTest {
    ...
    public void testKeysetValues() {
        try {
            ...
            if ((c[0].equals("key1") && c[1].equals("key2")) || (c[0].equals("key2") && c[1].equals("key1")))
            ...
            if ((c[0].equals("value1") && c[1].equals("value2")) || (c[0].equals("value1") && c[1].equals("value2")))
                Assert.assertTrue(true);
            else
                Assert.assertTrue(false);
    ...
    public void testgetMulti() {
        try {
            ...
            if ((values[0].equals("value1") && values[1].equals("value2")) || (values[0].equals("value1") && values[1].equals("value2")))
                Assert.assertTrue(true);
            else
                Assert.assertTrue(false);
    ...
    public void testStatsSlabs() {
        ...
        for (int i = 0; i < result.length; i++) {
            ...
            System.out.println(new StringBuffer().append("key:").append(node.getServerHost()).toString());
    ...
    public void testStats() {
        ...
        for (int i = 0; i < result.length; i++) {
            ...
            System.out.println(new StringBuffer().append("key:").append(node.getServerHost()).append(",value:").append(node.getStatInfo()));
        }
